...
export default function Info() {
    ...
    return (
        <div className="info grid justify-center tablet:grid-cols-2 Ptablet:grid-cols-4 laptop:grid-cols-4 mobile:grid-cols-2 smallmobile:grid-cols-2  px-3 mt-12">
            {data.map((info,index) => {
                return (
                    <div className='info-item flex items-center justify-center' key = {info+index}>
